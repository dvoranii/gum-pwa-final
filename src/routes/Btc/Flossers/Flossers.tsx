        ...
        <BaseCarouselSlide>
          <S.SlideWrapper>
            <S.SlideColumn1>
              <S.TitleListWrapper>
                <h4>
                  <span>Eco</span> <span>Clean®</span> <span>Flossers</span>{" "}
                  <span>Mint</span>
                </h4>
                <S.ListContainer>
                  <ul>
              ...
              <S.TitleListWrapper>
                <h4>
                  <span>Twisted</span> <span>Mint™</span> <span>Flossers</span>
                </h4>
                <S.ListContainer>
                  <ul>
                    <li>
                      Twisted mint floss removes 2x more plaque<sup>10</sup> and
                      covers 30% more surface area.<sup>11</sup>
                    </li>
                    <li>
              ...
              <S.TitleListWrapper>
                <h4>
                  <span>Comfort</span> <span>Slide</span> <span>Flossers</span>{" "}
                  <span>Mint</span>
                </h4>
                <S.ListContainer>
                  <ul>
                    <li>
                      Silky, non-stick mint floss easily slides between the
                      tightest contacts for gentle and effective flossing.
                    </li>
                    <li>
                      Lightweight flexible grip uses 20% less plastic.
                      <sup>13</sup>
              ...
              <S.TitleListWrapper>
                <h4>
                  <span>Advanced</span> <span>Care</span> <span>Flossers</span>{" "}
                  <span>Mint</span>
                </h4>
                <S.ListContainer>
                  <ul>
          ...
          <S.SlideWrapper $marginLeft="24px" $gap="0.3rem">
            <S.SlideColumn1>
              <S.TitleListWrapper $paddingTop="0">
                <h4>
                  <span>Professional</span> <span>Clean Plus</span>
                  <br /> <span>Flosser Picks</span> <span>Mint</span>
                </h4>
                <S.ListContainer>
                  <ul>
                    <li>
              ...
              <S.TitleListWrapper $paddingTop="1.2rem">
                <h4>
                  <span>Dual</span> <span>Technique®</span>
                  <br /> <span>Flossers</span> <span>Mint</span>
                </h4>
                <S.ListContainer>
                  <ul>
                    <li>
