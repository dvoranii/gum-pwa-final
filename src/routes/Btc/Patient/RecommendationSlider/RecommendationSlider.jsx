...
const RecommendationSlide = ({ priorityText, productName, productCode, slideImageSrc }) => (<S.Slide>
        <S.ProductImage src={slideImageSrc} alt={`${priorityText} recommendation: ${productName} (Code: ${productCode})`}/>
    </S.Slide>);
export const RecommendationSlider = ({ recommendations }) => {
    ...
    <Flickity className={'carousel'} elementType={'div'} options={flickityOptions} disableImagesLoaded={false} static={false}>
        <RecommendationSlide priorityText="Priority 1" productName={recommendations.priority1.product} productCode={recommendations.priority1.code} slideImageSrc={priority1Image}/>

        <RecommendationSlide priorityText="Priority 2" productName={recommendations.priority2.product} productCode={recommendations.priority2.code} slideImageSrc={priority2Image}/>

        {priority3Image && (<RecommendationSlide priorityText="Priority 3" productName={recommendations.priority3.product} productCode={recommendations.priority3.code} slideImageSrc={priority3Image}/>)}
