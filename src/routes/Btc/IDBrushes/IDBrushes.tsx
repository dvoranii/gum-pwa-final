      ...
      >
                ...
                <S.DiagramSection>
                  ...
                  <S.FeatureCallouts>
                    <S.NylonCallout $marginTop="12px">
                      <p>
                        Nylon coated wire helps
                        <br /> prevent galvanic shock
                      </p>
                    </S.NylonCallout>
              ...
              <S.Row1WrapperInner2>
                <S.TextAndImgWrapper>
                  <S.TextWrapper2>
                    ...
                    <p>
                      Ideal for patients who require additional assistance to
                      clean posterior interproximal spaces.
                    </p>
                    <S.ListContainer>
                      <ul>
                        <li>
        ...
        <BaseCarouselSlide>
          <S.Slide3WrapperOuter>
            ...
            <S.CaptionWrapper>
              <small>
                1. Data on File (DOF-0001)&nbsp;&nbsp;&nbsp;2. DOF-0046
              </small>
            </S.CaptionWrapper>
          </S.Slide3WrapperOuter>
        </BaseCarouselSlide>
