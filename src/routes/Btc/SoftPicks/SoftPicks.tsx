    ...
    <S.SoftPicksContainer>
      <S.Row1>
        <S.Column1>
          <S.TextContainer>
            <h2>
              Soft<span>-Picks®</span> Advanced
            </h2>
            <p>
              With a more comfortable rubber grip and longer curved handle for
          ...
          <S.TextContainer>
            <h2>
              Soft<span>-Picks®</span> Comfort Flex <span>Mint</span>
            </h2>
            <p>
              Refreshing mint, flexible rubber bristles slide between teeth for
              gentle, safe and effective food and biofilm removal.
            </p>
          </S.TextContainer>
          <S.ImgWrapper1>
          ...
          <S.Column1>
            <S.ImgAndTextWrapper>
              ...
              <S.TextWrapper>
                ...
                <p>
                  Our soft rubber picks massage gums and clean between teeth
                  without abrasion. They are latex-free and safe even for
                  sensitive and/allergic patients
                </p>
              </S.TextWrapper>
            </S.ImgAndTextWrapper>
          </S.Column1>
          <S.Column2>
            <S.ImgAndTextWrapper>
              ...
              <S.TextWrapper>
                ...
                <p>
                  Less demanding methods of interdental cleaning increase
                  patient motivation, compliance and outcomes.
                </p>
