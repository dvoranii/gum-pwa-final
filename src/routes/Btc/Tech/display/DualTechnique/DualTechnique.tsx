    ...
    <S.ContentWrapper>
      <S.TopRow>
        <S.ColumnLeft>
          <S.MainTitle>
            GUM
            <Trademark $size="36px" /> Dual
            <br />
            Technique
            <Trademark $size="36px" /> Flosser
          </S.MainTitle>
          <S.Description>
            <li>
              Dual ends specifically designed to reach front and back teeth.
            </li>
            <li>
              Twisted mint floss on the angled side removes 2x more plaque
              <sup>10</sup> and covers 30% more surface area.<sup>11</sup>
            </li>
          </S.Description>
          <S.ImgWrapper>
            <img src={MintFlavour} />
