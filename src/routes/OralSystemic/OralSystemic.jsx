...
export default function OralSystemicLink() {
    ...
    return (<ModuleContainer $isHomePage={isHomePage}>
        ...
        {isHomePage ? (<>
            ...
            <S.OralSystemicImgWrapperOuter>
              <S.ImagesWrapperInner showResults={!showCarousel && (activeHeart || activeBrain || activeBlood)}>
                ...
                <S.BaseImg src={showBaseImg2 ? BaseImg2 : OralSystemicImgFull} onPointerDown={toggleBaseImg}/>

                {showBaseImg2 && (<>
                    <S.Branches src={Branches}/>
                    
                    <S.HeartBranch src={HeartBranch} onPointerDown={toggleHeart}/>
                    {activeHeart && (<S.HeartActiveOverlay src={HeartActive} onPointerDown={(e) => e.stopPropagation()}/>)}

                    <S.BrainBranch src={BrainBranch} onPointerDown={toggleBrain}/>
                    {activeBrain && (<S.BrainActiveOverlay src={BrainActive} onPointerDown={(e) => e.stopPropagation()}/>)}

                    <S.BloodBranch src={BloodBranch} onPointerDown={toggleBlood}/>
                    {activeBlood && (<S.BloodActiveOverlay src={BloodActive} onPointerDown={(e) => e.stopPropagation()}/>)}
                  </>)}
              </S.ImagesWrapperInner>

              {showCarousel ? (<S.CarouselWrapper>
                  ...
                  {activeHeart && (<S.ResultImgWrapper>
                      <S.ResultContent>
                        <S.ResultTextImg src={HeartBranchResult}/>
                      </S.ResultContent>
                    </S.ResultImgWrapper>)}

                  {activeBrain && (<S.ResultImgWrapper>
                      <S.ResultContent>
                        <S.ResultTextImg $variant="brain" src={BrainBranchResult}/>
                      </S.ResultContent>
                    </S.ResultImgWrapper>)}

                  {activeBlood && (<S.ResultImgWrapper>
                      <S.ResultContent>
