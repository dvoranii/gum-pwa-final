...
export default function BtcTech() {
    ...
    return (<S.ContainerOuter>
      <S.HeaderLeft>
        <S.SideIcon>
          <img onPointerDown={() => handleIconTouch(1)} src={activeIcon === 1 ? Circle1Active : Circle1} alt="45 degree angle"/>
        </S.SideIcon>
        <S.SideIcon>
          <img onPointerDown={() => handleIconTouch(2)} src={activeIcon === 2 ? Circle2Active : Circle2} alt="Feature"/>
        </S.SideIcon>
