...
export default function ToothbrushTech() {
    ...
    const handleIconTouch = (iconNumber) => {
    ...
    return (<S.ContainerOuter>
      <S.HeaderLeft>
        <S.SideIcon onPointerDown={() => handleIconTouch(1)}>
          <img src={activeIcon === 1 ? Circle1Active : Circle1} alt="45 degree angle"/>
        </S.SideIcon>
        <S.SideIcon onPointerDown={() => handleIconTouch(2)}>
          <img src={activeIcon === 2 ? Circle2Active : Circle2} alt="Feature"/>
        </S.SideIcon>
        <S.SideIcon onPointerDown={() => handleIconTouch(3)}>
          <img src={activeIcon === 3 ? Circle3Active : Circle3} alt="Technology"/>
        </S.SideIcon>
        <S.SideIcon onPointerDown={() => handleIconTouch(4)}>
          <img src={activeIcon === 4 ? Circle4Active : Circle4} alt="Technology"/>
        </S.SideIcon>
      </S.HeaderLeft>
