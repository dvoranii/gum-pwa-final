  ...
  return (
    <S.ContentWrapper>
      <S.HeaderRight>
        ...
        <S.Description>
          <li>
            Designed to guide the hand to hold the brush at 45° in all quadrants
            so the bristles are properly positioned at the sulcus for optimal
        ...
        <S.BenefitsList>
          ...
          <S.BenefitItem>
            Available on all Technique® toothbrushes.
          </S.BenefitItem>
        </S.BenefitsList>
      </S.HeaderRight>
