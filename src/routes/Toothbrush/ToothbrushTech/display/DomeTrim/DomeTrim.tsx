    ...
    return(
        ...
        <S.ContentWrapper>
            <S.ColumnLeft>
                ...
                <S.Description>
                    <li>Designed to clean below the gumline where periodontal disease starts. The dome shape bristling structure helps promote the recommended 45° angle when using the modified Bass technique.</li>
                </S.Description>
                <S.ColLeftImgWrapper>
